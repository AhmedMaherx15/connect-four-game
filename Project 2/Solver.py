...
class Solver:
    ...
    def MiniMax_alpha_beta_pruning(self, board, current_depth, alpha, beta, maximizer_player=True, node=None):
    ...
    @lru_cache(maxsize=None)  # Cache the results to avoid redundant calculations and improve performance
    def MiniMax(self, board, current_depth, maximizer_player=True, node=None):
        self.node_counter += 1  # track how many nodes are evaluated
    ...
    def ExpectiMiniMax(self, board, current_depth, maximizer_player=True, node=None):
