...
def main():
    ...
    if algorithm == "Minimax":
        solver = Solver(depth=8, algorithm="minimax", draw_tree=False)
    elif algorithm == "Minimax with Pruning":
        solver = Solver(depth=4, algorithm="α-β pruning", draw_tree=False)
    else:
        solver = Solver(depth=4, algorithm="expectiminimax", draw_tree=False)
